...
<div class="col-md-12">
	<div class="widget">
		<header class="widget-header">
			<h4 class="widget-title">Editing</h4>
		</header><!-- .widget-header -->
		<hr class="widget-separator">
		<div class="widget-body">
			<?=form_open("rehber/update/".$items->id,array("class"=>"form-horizontal"));?>
				<div class="form-group">
					<?=form_label('Unit', 'birim_adi',array('class'=>'col-sm-2 col-md-2 col-lg-2 form-label text-right')); ?>
					<div class="col-sm-10 col-md-10 col-lg-10">
						<?=form_dropdown('birim_adi', SecenekDoldur($birimler,"Birim_Adi"),set_value('birim_adi',$items->birim),array("class"=>"form-control"));?>
					</div>
					<?php 
					if (isset($form_error)) { ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-10 col-md-10 col-lg-10">
						<?=form_input('gorevi', $items->gorevi,array("class"=>"form-control"));?>
					</div>
					<?php 
					if (isset($form_error)) { ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-10 col-md-10 col-lg-10">
					<?=form_dropdown('unvani', SecenekDoldur($unvanlar,"unvan_adi"),set_value('unvan_adi',$items->unvan),array("class"=>"form-control"));?>
					</div>
					<?php 
					if (isset($form_error)) { ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-10 col-md-10 col-lg-10">
						<?=form_input('adi_soyadi', $items->adi_soyadi,array("class"=>"form-control"));?>
					</div>
					<?php 
					if (isset($form_error)) { ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-10 col-md-10 col-lg-10">
						<?=form_input('telefon', $items->telefon,array("class"=>"form-control"));?>
					</div>
					<?php 
					if (isset($form_error)) { ?>
