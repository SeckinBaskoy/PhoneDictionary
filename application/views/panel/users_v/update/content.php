...
<div class="col-md-12">
	<div class="widget">
		<header class="widget-header">
			<h4 class="widget-title">Editing User Profile</h4>
		</header><!-- .widget-header -->
		<hr class="widget-separator">
		<div class="widget-body">
			<?=form_open("users/update/$items->id");?>
				<div class="form-group">
					<?=form_label('Full Name', 'full_name',array('class'=>'col-sm-2 col-md-2 col-lg-2 form-label text-right')); ?>
					<div class="col-sm-10 col-md-10 col-lg-10">
						<?=form_input('full_name', (isset($form_error)) ? set_value("full_name"):$items->full_name,array("class"=>"form-control"));?>
					</div>
				</div>
				<div class="form-group">
					<?=form_label('Username', 'user_name',array('class'=>'col-sm-2 col-md-2 col-lg-2 form-label text-right')); ?>
					<div class="col-sm-10 col-md-10 col-lg-10">
				...
				<div class="form-group">
					...
					<div class="col-sm-10 col-md-10 col-lg-10">
						<?php $emaildata = ['type'  => 'email','name'  => 'email','id' => 'email','class' => 'form-control','value'=>
						(isset($form_error)) ? set_value("email"):$items->email];?>
				...
				<div class="form-group">
					...
					<div class="col-sm-10 col-md-10 col-lg-10">
						<?=form_dropdown('user_role_id', SecenekDoldur($user_roles,"title"),set_value('user_role_id',$items->user_role_id),array("class"=>"form-control"));?>
					</div>
					<?php 
					if (isset($form_error)) { ?>
